...
public class userServices {
	...
	private static String currentUserTrainingPlan = "";
	private static String currentUserActivities = "";
	private static int currentworkinghours;
	private static int currenttargethours;
	private static String currentUserdata = "";
	private static String currenttrainer = "";
	...
	public void modifyTrainingPlan(int tagId, String trainingPlan, String trainingActivities) throws IOException {
		...
		try
		{
			...
			System.out.println(" ");
			System.out.println("The current Training plan - " + currentUserTrainingPlan + " has been modified to - " + trainingPlan);
			System.out.println("The current Training Activities - " + currentUserActivities + " has been modified to - " + trainingActivities);
